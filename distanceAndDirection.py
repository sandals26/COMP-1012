...
angle = math.atan2((y2-y1),(x2-x1)) #Angle made from the x axis to hypotenuse made by the x and y co-ordinates in radians
WALKING_SPEED = 4
print("You will walk a distance of {:.1f}km, in {:.1f} hours at a speed of 4km per hour, at an angle of {:.2f} radians".format(distance, distance/WALKING_SPEED, angle)) 